<template>
	<view class="page">
		...
		<u-popup v-model="showWin" v-if="Object.keys(list).length > 0" border-radius="20" mode="center" width="95%"
			:closeable="true">
			<view class="soList">
				<view class="soListTitle l-b-t-primary">风水命</view>
				<view class="soListContent c-info">
					{{list.xu_hao}}{{list.yan_se}}{{list.wu_xing}}
				</view>
				<view class="soListTitle l-b-t-primary">九星为</view>
				<view class="soListContent c-info">
					{{list.xing_ming}}星
				</view>				
				...
				<view class="soListTitle l-b-t-primary">太乙诗歌</view>
				<view class="soListContent c-info">
					{{list.tai_yi_shi_ge}}
				</view>				
