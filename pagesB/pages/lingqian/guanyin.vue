<template>
	<view class="page bg-white">
		...
		<u-popup v-model="showWin" v-if="Object.keys(list).length > 0" border-radius="20" mode="center" width="95%"
			:closeable="true">
			<view class="qianBox">
				<view class="qianTitle u-text-center">{{list.qian}} {{list.qian_ming}} {{list.ji_xiong}}</view>
				<view class="qianTitle l-b-t-primary">签文</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.qian_wen)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">签语</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.shi_yi)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">解签</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.jie_yue)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">仙机</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.xian_ji)"></u-parse>
				</view>
	...
	export default {
		...
		methods: {
			getChouQian() {			
				...
				setTimeout(() => {
					//开始查询
					that.post('ling_qian/guan_yin', {}, res => {
						that.disabled = false;
						that.showWin = true;
