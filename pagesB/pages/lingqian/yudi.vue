	...
	<view class="page bg-white">
		...
		<u-popup v-model="showWin" v-if="Object.keys(list).length > 0" border-radius="20" mode="center" width="95%"
			...
			<view class="qianBox">
				...
				<view class="qianTitle l-b-t-primary">卦曰</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.gua_yue)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">解曰</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.jie_yue)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">断曰</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.duan_yue)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">清凉月解</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.qing_liang_yue_jie)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">典故</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.dian_gu)"></u-parse>
				</view>
			</view>
		</u-popup>
	</view>
