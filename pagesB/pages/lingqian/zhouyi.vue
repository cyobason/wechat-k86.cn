	...
	<view class="page bg-white">
		...
		<u-popup v-model="showWin" v-if="Object.keys(list).length > 0" border-radius="20" mode="center" width="95%"
			...
			<view class="qianBox">
				...
				<view class="qianTitle l-b-t-primary">周易卦爻辞原文</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.yuan_wen)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">卦爻辞注解</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.zhu_jie)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">卦意</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.gua_yi)"></u-parse>
				</view>
	...
	export default {
		...
		methods: {
			getChouQian() {
				...
				setTimeout(() => {
					//开始查询
					that.post('ling_qian/zhou_yi_suan_gua', {}, res => {
						that.disabled = false;
						that.showWin = true;
