	...
	<view class="page bg-white">
		...
		<u-popup v-model="showWin" v-if="Object.keys(list).length > 0" border-radius="20" mode="center" width="95%"
			...
			<view class="qianBox">
				...
				<view class="qianTitle l-b-t-primary">白话</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.bai_hua)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">批注</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.pi_zhu)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">评论</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.ping_lun)"></u-parse>
				</view>
	...
	export default {
		...
		methods: {
			getChouQian() {				
				...
				setTimeout(() => {
					//开始查询
					that.post('ling_qian/bao_sheng_da_di', {}, res => {
						that.disabled = false;
						that.showWin = true;
