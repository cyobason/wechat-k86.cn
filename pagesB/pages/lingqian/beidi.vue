<template>
	<view class="page bg-white">
		...
		<u-popup v-model="showWin" v-if="Object.keys(list).length > 0" border-radius="20" mode="center" width="95%"
			:closeable="true">
			<view class="qianBox">
				<view class="qianTitle u-text-center">{{list.qian}} {{list.qian_ming}} {{list.ji_xiong}}签</view>
				...
				<view class="qianTitle l-b-t-primary">谋望</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.mou_wang)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">家宅</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.jia_zhai)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">婚姻</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.hun_yin)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">失物</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.shi_wu)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">官事</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.guan_shi)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">行人</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.xing_ren)"></u-parse>
				</view>
				<view class="qianTitle l-b-t-primary">占病</view>
				<view class="qianContent">
					<u-parse :html="nl2br(list.zhan_bing)"></u-parse>
				</view>
			</view>
		</u-popup>
	</view>
	...
	export default {
		...
		methods: {
			getChouQian() {				
				...
				setTimeout(() => {
					//开始查询
					that.post('ling_qian/bei_di', {}, res => {
						that.disabled = false;
						that.showWin = true;
